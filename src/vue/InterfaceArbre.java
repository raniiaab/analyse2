...
public class InterfaceArbre extends JPanel {
	...
	private JButton afficherMatrice, afficherFsAps, afficherArcOuAretes, Rang, Distance, pruferCodage, pruferDecodage, ajoutSommet, supSommet, ajoutArc, supArc, afficheGraphe;;
	...
	public InterfaceArbre() {
		...
		sais.setBackground(new Color(47,47,47));
		sais.setForeground(Color.WHITE);
        add(sais);
		...
		pruferDecodage.setBackground(new Color(47,47,47));
		pruferDecodage.setForeground(Color.WHITE);
		add(pruferDecodage);
		...
		pruferCodage.setBackground(new Color(47,47,47));
		pruferCodage.setForeground(Color.WHITE);
		add(pruferCodage);
		...
		afficheGraphe.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(graphe == null)
					...
					DessinGraphe de = new DessinGraphe(graphe.getD_nb_sommet(), graphe.getAretes(), "abr");
					de.setSize(new Dimension(GraphicsEnvironment.getLocalGraphicsEnvironment().getMaximumWindowBounds().width, GraphicsEnvironment.getLocalGraphicsEnvironment().getMaximumWindowBounds().height));
					frame1.add(de);
